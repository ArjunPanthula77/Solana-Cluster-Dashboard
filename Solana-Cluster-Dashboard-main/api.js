...
const pool = new Pool({
  connectionString: process.env.DATABASE_URL || "postgresql://opsonchain_user:pCHPUTUW5w79pGWvrWOPEKLauLKMwuwB@dpg-d3ao36f5r7bs73d7abm0-a.frankfurt-postgres.render.com/opsonchain",
  ssl: {
    rejectUnauthorized: false, // allow self-signed certs
  },
});
...
function startApi(startPolling, stopPolling) {
  initDB(); // Call on startup
